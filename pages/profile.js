            ...
            <div>
                {isMyUser && !editMode &&(
                    <button onClick = {()=> {
                        ...
                        className=" bg-emerald-500 py-1 px-2 rounded-md shadow-md shadow-gray-500">Edit</button>
                )}
                {isMyUser && editMode && (
                    <button onClick = {saveProfile}className=" bg-emerald-500 py-1 px-2 rounded-md shadow-md shadow-gray-500">Save Changes</button>
                )}
            </div>
            </div>
